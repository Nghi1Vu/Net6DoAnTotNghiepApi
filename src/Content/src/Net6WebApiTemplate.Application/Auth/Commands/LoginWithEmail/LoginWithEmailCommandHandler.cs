...
{
    public class LoginWithEmailCommandHandler : IRequestHandler<LoginWithEmailCommand, AuthResult>
    {
        //private readonly ISignInManager _signInManager;
        private readonly IJwtTokenManager _jwtTokenManager;
        private readonly IProductRepository _productRepository;
        public LoginWithEmailCommandHandler(IProductRepository productRepository, IJwtTokenManager jwtTokenManager)
        {
        ...
        public async Task<AuthResult> Handle(LoginWithEmailCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                bool checkLogin= _productRepository.LoginWithEmail(request.email);
                if (checkLogin)
                {
